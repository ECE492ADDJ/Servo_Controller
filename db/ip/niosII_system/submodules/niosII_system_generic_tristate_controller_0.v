...
module niosII_system_generic_tristate_controller_0 #(
		...
		output wire        tcm_write_out,        //   tcm.write_out
	...
	altera_tristate_controller_aggregator #(
		...
		.clk                    (clk_clk),                                         //                       clk.clk
		.reset                  (reset_reset),                                     //                     reset.reset
		.tcm0_write             (tcm_write_out),                                   // tristate_conduit_master_0.write_out
