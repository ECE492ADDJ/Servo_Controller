...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../servo.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../niosII_system.sopcinfo
...
# Design Name 
# setting SOPC_NAME is niosII_system
SOPC_NAME := niosII_system
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1109098
SOPC_SYSID_FLAG += --sidp=0x1109098
ELF_PATCH_FLAG  += --sidp 0x1109098

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1487794904
SOPC_SYSID_FLAG += --timestamp=1487794904
ELF_PATCH_FLAG  += --timestamp 1487794904
...
# setting hal.enable_lightweight_device_driver_api is 0
